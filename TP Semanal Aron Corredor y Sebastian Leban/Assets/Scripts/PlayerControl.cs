...
public class PlayerControl : MonoBehaviour
{
    ...
    //Ball Throw
    public GameObject playerHUDBall;
    ...
    public static int PlayerKnockback; //TO DO: Se tiene que cambiar para 2 players
    ...
    private void ShowBall()
    {
        if (ballAmmoCount == 0)
        {
            playerHUDBall.SetActive(false);
        }
        else
        {
            playerHUDBall.SetActive(true);
        }
    }
}
